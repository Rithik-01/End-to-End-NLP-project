...
from hate.components.data_tranformation import DataTransformation
...
class TrainPipeline:
    ...
    def start_data_validation(self):
        ...
        try:
            config = DataValidationCongif()
            obj=DataValidation(config)
            result=obj.data_validation()
            logging.info(f"the result got from the data_validation method is {result} ")

            logging.info("Exited the start_data_validation method of Trainpipeline.")
        except Exception as e:
            raise CustomException(e, sys) from e
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            logging.info(f"model_evaluation_artifacts:{model_evaluation_artifacts.is_model_accepted}")
